...
* Modified by Mia Koring for use in Amethyst Browser
*****************************************************/
(function(global,factory){(global.AmethystBrowserMark=factory())}(this,(function(){'use strict';class DOMIterator{constructor(ctx,iframes=!0,exclude=[],iframesTimeout=5000){this.ctx=ctx;this.iframes=iframes;this.exclude=exclude;this.iframesTimeout=iframesTimeout}
...
function Mark$1(ctx){const instance=new Mark(ctx);this.mark=(sv,opt)=>{instance.mark(sv,opt);return this};this.markRegExp=(sv,opt)=>{instance.markRegExp(sv,opt);return this};this.markRanges=(sv,opt)=>{instance.markRanges(sv,opt);return this};this.unmark=(opt)=>{instance.unmark(opt);return this};return this}
return Mark$1})))
"""#
